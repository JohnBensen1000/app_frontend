...
class CustomDrawer extends StatefulWidget {
  ...
  // left side of the page. The drawer covers about 60% of the screen width and
  ...
  CustomDrawer({Key key, @required this.width, @required this.child})
      : super(key: key);
        ...
        child: Consumer<CustomDrawerProvider>(
            builder: (context, provider, child) => Stack(children: <Widget>[
                  ...
                  Row(
                    children: [
                      Transform.translate(
                        offset: Offset(provider.xOffset * -widget.width, 0),
                        child: widget.child,
                      ),
                      GestureDetector(
                          child: Container(
                          ...
                          onTap: () async {
                            ...
                            profileProvider.isProfileDrawerOpen = false;
                          })
                    ],
                  )
                ])));
