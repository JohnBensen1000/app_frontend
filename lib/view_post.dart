...
class ViewPostScaffold extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: ViewPostAppBar(height: 40),
    );
  }
}

class ViewPostAppBar extends PreferredSize {
...
class PostWidgetState extends InheritedWidget {
  PostWidgetState({
    @required this.post,
  ...
  @override
  bool updateShouldNotify(PostWidgetState old) => post != old.post;
}
